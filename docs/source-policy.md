...
- Source URL or file reference, publisher, retrieval date, observation period, confidence, geography, and synthetic status are preserved.
- Source and place geography must match exactly in Milestone 1; no silent geography substitution is permitted.
- Non-synthetic sources older than the configured maximum age are rejected.
